...
#Small hack, PHYSICS_PT_add doesn't have COMPAT_ENGINES, override its poll function instead
from bl_ui import properties_physics_common
properties_physics_common.PHYSICS_PT_add.poll = fake_poll(properties_physics_common.PHYSICS_PT_add.poll)
del properties_physics_common
 
 
# /usr/share/blender/2.68/scripts/startup/bl_ui 

for name in ['scene', 'material', 'texture', 'object', 'particle']:
...
properties_game.PHYSICS_PT_game_collision_bounds.COMPAT_ENGINES.add('CRYSTALSPACE')
properties_game.PHYSICS_PT_game_obstacles.COMPAT_ENGINES.add('CRYSTALSPACE')
...
properties_data_lamp.DATA_PT_context_lamp.COMPAT_ENGINES.add('CRYSTALSPACE')
...
properties_data_lamp.DATA_PT_falloff_curve.COMPAT_ENGINES.add('CRYSTALSPACE')
properties_data_lamp.DATA_PT_custom_props_lamp.COMPAT_ENGINES.add('CRYSTALSPACE')
