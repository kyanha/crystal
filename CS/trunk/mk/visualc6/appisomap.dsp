...
# ADD RSC /l 0x409 /d "NDEBUG" /fo".\csrelease\temp\appisomap\appisomap.res"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 user32.lib advapi32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 shell32.lib gdi32.lib user32.lib advapi32.lib libceltools.lib libcstool.lib libcsgfx.lib libcsgeom.lib libcsutil.lib zlib.lib /nologo /subsystem:console /machine:I386 /out:"csrelease\temp\appisomap\isomap.exe" /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs"  /OPT:NOREF
...
# ADD RSC /l 0x409 /d "_DEBUG" /d "CS_DEBUG" /fo".\csdebug\temp\appisomap\appisomap.res"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 user32.lib advapi32.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept
# ADD LINK32 shell32.lib gdi32.lib user32.lib advapi32.lib libceltools_d.lib libcstool_d.lib libcsgfx_d.lib libcsgeom_d.lib libcsutil_d.lib zlib.lib /nologo /subsystem:console /debug /machine:I386 /out:"csdebug\temp\appisomap\isomap.exe" /pdbtype:sept /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs" 
# Begin Special Build Tool
