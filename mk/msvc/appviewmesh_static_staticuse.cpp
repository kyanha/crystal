...
SCF_USE_STATIC_PLUGIN(debug)
SCF_USE_STATIC_PLUGIN(lookat)
SCF_USE_STATIC_PLUGIN(noise)
SCF_USE_STATIC_PLUGIN(ragdoll)
SCF_USE_STATIC_PLUGIN(ragdoll2)
SCF_USE_STATIC_PLUGIN(retarget)
SCF_USE_STATIC_PLUGIN(speed)
