...
# ADD LINK32 shell32.lib gdi32.lib user32.lib advapi32.lib libceltools.lib libcstool.lib libcsgfx.lib libcsgeom.lib libcsutil.lib zlib.lib /nologo /subsystem:console /machine:I386 /out:"csrelease\temp\appvsh\vsh.exe" /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs"  /OPT:NOREF
...
# ADD LINK32 shell32.lib gdi32.lib user32.lib advapi32.lib libceltools_d.lib libcstool_d.lib libcsgfx_d.lib libcsgeom_d.lib libcsutil_d.lib zlib.lib /nologo /subsystem:console /debug /machine:I386 /out:"csdebug\temp\appvsh\vsh.exe" /pdbtype:sept /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs" 
# Begin Special Build Tool
