...
# ADD LINK32 shell32.lib user32.lib gdi32.lib advapi32.lib delayimp.lib libmng.lib zlib.lib libjpeg.lib /DELAYLOAD:libmng.dll /DELAYLOAD:libz.dll /DELAYLOAD:libjpeg.dll  /nologo /version:4.0 /subsystem:windows /dll /machine:I386 /out:"csrelease\temp\plgcsjngimg\csjngimg.dll" /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs"  /OPT:NOREF
...
# ADD LINK32 shell32.lib user32.lib gdi32.lib advapi32.lib delayimp.lib libmng.lib zlib.lib libjpeg.lib /DELAYLOAD:libmng.dll /DELAYLOAD:libz.dll /DELAYLOAD:libjpeg.dll  /nologo /version:1.0 /subsystem:windows /dll /profile /debug /machine:I386 /out:"csdebug\temp\plgcsjngimg\csjngimg.dll" /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs" 
...
LINK32=link.exe
# ADD BASE LINK32 user32.lib gdi32.lib advapi32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /pdbtype:sept
# ADD LINK32 shell32.lib user32.lib gdi32.lib advapi32.lib delayimp.lib libmng.lib zlib.lib libjpeg.lib /DELAYLOAD:libmng.dll /DELAYLOAD:libz.dll /DELAYLOAD:libjpeg.dll  /nologo /version:1.0 /subsystem:windows /dll /profile /debug /machine:I386 /out:"csmemdbg\temp\plgcsjngimg\csjngimg.dll" /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs" 
# SUBTRACT LINK32 /profile
# Begin Special Build Tool
